      ...
      >
        ...
        {fullPlayer ? (
          <>
            {/* ── Annuncio evento ───────────────────────────────── */}
            <a
              href="https://chat.whatsapp.com/LnZvWR2ffXgIfzPCUFE7jL?mode=gi_t"
              target="_blank"
            ...
            >
              ...
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-white/20">
                <svg viewBox="0 0 24 24" className="h-6 w-6 fill-white" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.126 1.532 5.862L.057 23.428a.75.75 0 0 0 .937.903l5.4-1.716A11.942 11.942 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75c-1.9 0-3.687-.524-5.21-1.437l-.375-.224-3.876 1.232 1.07-3.768-.244-.389A9.718 9.718 0 0 1 2.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z"/>
                </svg>
              </div>
              <div className="min-w-0 flex-1">
                <p className="text-xs font-bold uppercase tracking-widest text-white/70">📍 Bagnino 29 · Rimini</p>
                <p className="font-black text-white leading-tight">Ritrovo Torneo — Ore 13</p>
                <p className="mt-0.5 text-xs font-semibold text-white/80">Entra nel gruppo WhatsApp →</p>
              </div>
            </a>
            ...
            <div className="slide-up stagger-2 rounded-2xl bg-[var(--surface-2)] p-5">
              ...
              <Link href="/level-info" className="flex items-center justify-between">
