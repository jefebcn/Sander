...
const carousels = [
  {
    id: "c1-carta",
    slides: [
      { kind: "hook", kicker: "LA TUA CARTA", big: ["Il beach volley", "della Riviera ora ha", "le sue FIGURINE."], emoji: "🃏", swipe: true },
      { kind: "value", kicker: "COME FUNZIONA", big: ["Come le carte", "di FIFA."], sub: "Ma il giocatore sei TU.", emoji: "⚡" },
      { kind: "value", kicker: "PROGRESSIONE", big: ["Sale di livello", "ogni volta", "che vinci."], sub: "Bronzo → Argento → Oro", emoji: "📈" },
      { kind: "value", kicker: "LE TUE STAT", big: ["Attacco. Difesa.", "Muro. Ricezione."], sub: "Le tue statistiche reali, in una carta.", emoji: "🏐" },
      { kind: "cta", big: ["Crea la tua", "carta. Gratis."], sub: "In 30 secondi, dal telefono." },
    ],
  },
  {
    id: "c2-bagni",
    slides: [
      { kind: "hook", kicker: "RE DEI BAGNI", big: ["Il tuo bagno", "ha un RE."], sub: "(e probabilmente non sei tu)", emoji: "👑", swipe: true },
      { kind: "value", kicker: "TERRITORIO", big: ["Ogni bagno", "della Riviera", "ha la sua classifica."], emoji: "🏖️" },
      { kind: "value", kicker: "LA REGOLA", big: ["Vinci sul campo →", "conquisti il bagno."], sub: "Chi vince di più comanda.", emoji: "🏐" },
      { kind: "value", kicker: "CHI DOMINA?", big: ["26 · 29 · 42", "44 · 60 · 67"], sub: "Qual è il tuo?", emoji: "📍" },
      { kind: "cta", big: ["Conquista", "il tuo bagno."], sub: "La classifica del tuo campo ti aspetta." },
    ],
  },
  {
    id: "c3-whatsapp",
    slides: [
      { kind: "hook", kicker: "ORGANIZZARE PARTITE", big: ["Ancora organizzi", "il beach volley", "su WhatsApp?"], emoji: "🤦", swipe: true },
      { kind: "value", kicker: "STEP 1", big: ["Crea una partita", "in 2 tap."], sub: "Data, campo, formato. Fatto.", emoji: "⚡" },
      { kind: "value", kicker: "STEP 2", big: ["Trova giocatori", "del tuo livello."], sub: "Niente più squadre sbilanciate.", emoji: "🤝" },
...
function slideHtml(s, idx, total, carouselId) {
  ...
  const bigLines = s.big
    .map((l) => `<div>${l.replace("TU.", `<span style="color:${ACCENT}">TU.</span>`).replace("FIGURINE.", `<span style="color:${ACCENT}">FIGURINE.</span>`).replace("RE.", `<span style="color:${ACCENT}">RE.</span>`).replace("WhatsApp?", `<span style="color:${ACCENT}">WhatsApp?</span>`)}</div>`)
    .join("")
